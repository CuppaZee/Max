...
function ClanStatsTableInternal({
  requirements,
  requirements_data,
  actual_clan_id,
  stats,
  ...
  return useMemo(() => {
    ...
    const main_users = [
      ...
      ...Object.values(stats.users).sort(sort as any),
      stats,
              ...
              <View
                ...
                {main_rows.map(row => {
                  ...
                  if (typeof row === "number" && typeof column !== "number") {
                    user = column;
                    task_id = row;
                  } else if (typeof column === "number" && typeof row !== "number") {
                    user = row;
                    task_id = column;
                  }
                  const key =
...
export default function ClanStatsTable({
  game_id,
  clan_id: actual_clan_id,
  title,
  scrollViewController,
  ...
  const requirements_data = useMunzeeRequest(
  ...
  console.log("~PCLAN:", actual_clan_id);
  ...
  return (
    <ClanStatsTableInternal
      requirements_data={requirements_data}
      requirements={requirements}
      actual_clan_id={actual_clan_id}
      stats={stats}
      size={size}
      clan_id={clan_id}
      onLayout={onLayout}
